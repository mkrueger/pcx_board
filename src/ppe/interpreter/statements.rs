...
pub fn call_predefined_procedure(
    ...
    match def.opcode {
        ...
        OpCode::DTRON => predefined_procedures::dtron(interpreter, params),
        ...
        OpCode::DECLARE => predefined_procedures::declare(interpreter, params),
        OpCode::FUNCTION => predefined_procedures::function(interpreter, params),
        OpCode::PROCEDURE => predefined_procedures::procedure(interpreter, params),
        OpCode::PCALL => predefined_procedures::pcall(interpreter, params),
        OpCode::FPCLR => predefined_procedures::fpclr(interpreter, params),
        OpCode::BEGIN => predefined_procedures::begin(interpreter, params),
        OpCode::FEND => predefined_procedures::fend(interpreter, params),
